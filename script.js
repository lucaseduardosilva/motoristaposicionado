        ...
        if (translation) {
            if (element.tagName === 'INPUT' || element.tagName === 'TEXTAREA') {
                ...
                if (hrefTranslation && lang === 'en') {
                    element.href = `https://wa.me/5519999999999?text=Hello,%20I%20would%20like%20to%20request%20a%20quote`;
                } else if (hrefTranslation && lang === 'pt') {
                    element.href = `https://wa.me/5519999999999?text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento`;
                }
            } else {
    ...
    whatsappLinks.forEach(link => {
        if (lang === 'en') {
            if (link.textContent.includes('Consultar') || link.textContent.includes('Check')) {
                link.href = 'https://wa.me/5519999999999?text=Hello,%20I%20would%20like%20to%20check%20available%20vehicles';
            } else if (link.textContent.includes('Falar') || link.textContent.includes('Talk')) {
                link.href = 'https://wa.me/5519999999999?text=Hello,%20I%20would%20like%20to%20request%20a%20quote';
            }
        } else {
            if (link.textContent.includes('Consultar') || link.textContent.includes('Check')) {
                link.href = 'https://wa.me/5519999999999?text=Olá,%20gostaria%20de%20consultar%20os%20veículos%20disponíveis';
            } else if (link.textContent.includes('Falar') || link.textContent.includes('Talk')) {
                link.href = 'https://wa.me/5519999999999?text=Olá,%20gostaria%20de%20solicitar%20um%20orçamento';
            }
        }
    });
}
...
Mensagem: ${formData.mensagem}
            ...
            const mailtoLink = `mailto:motoristaposicionado@gmail.com?subject=Solicitação de Orçamento - ${formData.servico}&body=${encodeURIComponent(emailBody)}`;
